...
const jobBaseData = {
    "Beggar": { name: "Beggar", maxXp: 50, income: 500, heroxp: 36 },
    "Farmer": { name: "Farmer", maxXp: 100, income: 900, heroxp: 37 },
    "Fisherman": { name: "Fisherman", maxXp: 20000, income: 15, heroxp: 38 },
    "Miner": { name: "Miner", maxXp: 400, income: 40000, heroxp: 39 },
    "Blacksmith": { name: "Blacksmith", maxXp: 80000, income: 80, heroxp: 40 },
    "Merchant": { name: "Merchant", maxXp: 160000, income: 150, heroxp: 41 },

    "Squire": { name: "Squire", maxXp: 42, income: 500, heroxp: 51 },
    "Footman": { name: "Footman", maxXp: 1000, income: 5000, heroxp: 52 },
    "Veteran footman": { name: "Veteran footman", maxXp: 1000000, income: 120, heroxp: 53 },
    "Centenary": { name: "Centenary", maxXp: 100000, income: 30000, heroxp: 54 },
    "Knight": { name: "Knight", maxXp: 1000000, income: 100000, heroxp: 63 },
    "Veteran Knight": { name: "Veteran Knight", maxXp: 750000000, income: 3000, heroxp: 63 },
    "Holy Knight": { name: "Holy Knight", maxXp: 4e7, income: 500000, heroxp: 64 },
...
const skillBaseData = {
    ...
    "Evil Control": { name: "Evil Control", maxXp: 100, heroxp: 156, effect: 10.01, description: "Evil Gain" },
    "Intimidation": { name: "Intimidation", maxXp: 100, heroxp: 157, effect: -3.01, description: "Reduced Expenses" },
    "Demon Training": { name: "Demon Training", maxXp: 100, heroxp: 174, effect: 5.01, description: "All XP" },
    "Blood Meditation": { name: "Blood Meditation", maxXp: 100, heroxp: 176, effect: 3.01, description: "Evil Gain" },
    "Demon's Wealth": { name: "Demon's Wealth", maxXp: 100, heroxp: 178, effect: 1.002, description: "Hero Pay" },
    "Dark Knowledge": { name: "Dark Knowledge", maxXp: 100, heroxp: 180, effect: 1.003, description: "Hero XP" },

    "Void Influence": { name: "Void Influence", maxXp: 100, heroxp: 206, effect: 1.0028, description: "All XP" },
    "Time Loop": { name: "Time Loop", maxXp: 100, heroxp: 207, effect: 1.001, description: "Gamespeed" },
    "Evil Incarnate": { name: "Evil Incarnate", maxXp: 100, heroxp: 208, effect: 1.01, description: "Skill XP" },
    "Absolute Wish": { name: "Absolute Wish", maxXp: 100, heroxp: 198, effect: 1.005, description: "Evil Gain" },
    "Void Amplification": { name: "Void Amplification", maxXp: 100, heroxp: 251, effect: 1.01, description: "The Void XP" },
    "Mind Release": { name: "Mind Release", maxXp: 100, heroxp: 251, effect: 1.0006, description: "Increased Happiness" },
    "Ceaseless Abyss": { name: "Ceaseless Abyss", maxXp: 100, heroxp: 251, effect: 1.000585, description: "Longer Lifespan" },
    "Void Symbiosis": { name: "Void Symbiosis", maxXp: 100, heroxp: 253, effect: 1.0015, description: "Skill XP" },
    "Void Embodiment": { name: "Void Embodiment", maxXp: 100, heroxp: 258, effect: 1.0025, description: "Evil Gain" },
    "Abyss Manipulation": { name: "Abyss Manipulation", maxXp: 100, heroxp: 266, effect: -1.01, description: "Reduced Expenses" },

    "Cosmic Longevity": { name: "Cosmic Longevity", maxXp: 100, heroxp: 266, effect: 1.0015, description: "Longer Lifespan" },
    "Cosmic Recollection": { name: "Cosmic Recollection", maxXp: 100, heroxp: 272, effect: 1.00065, description: "Max Lvl Multiplier" },
    "Essence Collector": { name: "Essence Collector", maxXp: 100, heroxp: 288, effect: 5.01, description: "Essence Gain" },
    "Galactic Command": { name: "Galactic Command", maxXp: 100, heroxp: 290, effect: -1.01, description: "Reduced Expenses" },

    "Yin Yang": { name: "Yin Yang", maxXp: 100, heroxp: 290, effect: 1.020, description: "Essence + Evil Gain" },
    "Parallel Universe": { name: "Parallel Universe", maxXp: 100, heroxp: 300, effect: 1.02, description: "All XP" },
...
const itemBaseData = {
    ...
    "Tent": { name: "Tent", expense: 0, effect: 1000000000000.4, heromult: 2, heroeffect: 2e7 },

    "Wooden Hut": { name: "Wooden Hut", expense: 0, effect: 2, heromult: 3, heroeffect: 2e8 },
    "Cottage": { name: "Cottage", expense: 0, effect: 3.5, heromult: 3, heroeffect: 2e9 },
    "House": { name: "House", expense: 0, effect: 6, heromult: 4, heroeffect: 2e10 },
    "Large House": { name: "Large House", expense: 0, effect: 12, heromult: 4, heroeffect: 2e11 },
    "Small Palace": { name: "Small Palace", expense: 0, effect: 25, heromult: 5, heroeffect: 2e12 },
    "Grand Palace": { name: "Grand Palace", expense: 0, effect: 60, heromult: 5, heroeffect: 2e13 },
    "Town Ruler": { name: "Town Ruler", expense: 0, effect: 120, heromult: 6, heroeffect: 2e15 },
    "City Ruler": { name: "City Ruler", expense: 0, effect: 500, heromult: 7, heroeffect: 2e17 },
    "Nation Ruler": { name: "Nation Ruler", expense: 0, effect: 1200, heromult: 8, heroeffect: 2e19 },
    "Pocket Dimension": { name: "Pocket Dimension", expense: 0, effect: 5000, heromult: 9, heroeffect: 2e22 },
    "Void Realm": { name: "Void Realm", expense: 0, effect: 15000, heromult: 10, heroeffect: 2e25 },
    "Void Universe": { name: "Void Universe", expense: 0, effect: 30000, heromult: 11, heroeffect: 2e28 },
    "Astral Realm": { name: "Astral Realm", expense: 0, effect: 150000, heromult: 12, heroeffect: 2e31 },
    "Galactic Throne": { name: "Galactic Throne", expense: 0, effect: 300000, heromult: 13, heroeffect: 2e35 },
    "Spaceship": { name: "Spaceship", expense: 0, effect: 1500000, heromult: 15, heroeffect: 5e42 },
    "Planet": { name: "Planet", expense: 0, effect: 5000000, heromult: 16, heroeffect: 5e46 },
    "Ringworld": { name: "Ringworld", expense: 0, effect: 50000000, heromult: 17, heroeffect: 5e49 },

    // Heroic only
    "Stellar Neighborhood": { name: "Stellar Neighborhood", expense:0, effect: 60000000, heromult: 17, heroeffect: 6e49,  },
    "Galaxy": { name: "Galaxy", expense: 0, effect: 75000000, heromult: 18, heroeffect: 7.5e49 },
    "Supercluster": { name: "Supercluster", expense: 0, effect: 100000000, heromult: 20, heroeffect: 1e50 },
    "Galaxy Filament": { name: "Galaxy Filament", expense: 0, effect: 1000000000, heromult: 25, heroeffect: 1e52 },
    "Observable Universe": { name: "Observable Universe", expense: 0, effect: 10000000000, heromult: 30, heroeffect: 1e54 },
    "Multiverse": { name: "Multiverse", expense: 0, effect: 100000000000, heromult: 35, heroeffect: 1e60 },
    "Quantum World": { name: "Quantum World", expense: 0, effect: 1000000000000, heromult: 40, heroeffect: 1e64 },
    "Boötes Void": { name: "Boötes Void", expense: 0, effect: 1000000000000, heromult: 40, heroeffect: 1e80 },

    // Misc
    "Book": { name: "Book", expense: 0, effect: 1.5, description: "Skill XP", heromult: 2, heroeffect: 10 },
    "Dumbbells": { name: "Dumbbells", expense: 0, effect: 1.5, description: "Strength XP", heromult: 2, heroeffect: 10 },
    "Personal Squire": { name: "Personal Squire", expense: 0, effect: 2, description: "Hero XP", heromult: 3, heroeffect: 10 },
    "Steel Longsword": { name: "Steel Longsword", expense: 0, effect: 2, description: "Military XP", heromult: 3, heroeffect: 10 },
    "Butler": { name: "Butler", expense: 0, effect: 1.5, description: "Happiness", heromult: 4, heroeffect: 10 },
    "Sapphire Charm": { name: "Sapphire Charm", expense: 0, effect: 3, description: "Magic XP", heromult: 4, heroeffect: 10 },
    "Study Desk": { name: "Study Desk", expense: 0, effect: 2, description: "Skill XP", heromult: 5, heroeffect: 10 },
    "Library": { name: "Library", expense: 0, effect: 2, description: "Skill XP", heromult: 5, heroeffect: 10 },
    "Observatory": { name: "Observatory", expense: 0, effect: 5, description: "Magic XP", heromult: 6, heroeffect: 10 },
    "Mind's Eye": { name: "Mind's Eye", expense: 0, effect: 10, description: "Fundamentals XP", heromult: 8, heroeffect: 10 },
    "Void Necklace": { name: "Void Necklace", expense: 0, effect: 3, description: "Void Manipulation XP", heromult: 10, heroeffect: 10 },
    "Void Armor": { name: "Void Armor", expense: 0, effect: 3, description: "The Void XP", heromult: 10, heroeffect: 10 },
    "Void Blade": { name: "Void Blade", expense: 0, effect: 3, description: "Skill XP", heromult: 11, heroeffect: 10 },
    "Void Orb": { name: "Void Orb", expense: 0, effect: 3, description: "Void Manipulation XP", heromult: 11, heroeffect: 10 },
    "Void Dust": { name: "Void Dust", expense: 0, effect: 3, description: "The Void XP", heromult: 12, heroeffect: 10 },
    "Celestial Robe": { name: "Celestial Robe", expense: 0, effect: 5, description: "Galactic Council XP", heromult: 12, heroeffect: 10 },
    "Universe Fragment": { name: "Universe Fragment", expense: 0, effect: 3, description: "Skill XP", heromult: 13, heroeffect: 1000000 },
    "Multiverse Fragment": { name: "Multiverse Fragment", expense: 0, effect: 5, description: "Happiness", heromult: 15, heroeffect: 1000000 },
    "Stairway to heaven": { name: "Stairway to heaven", expense: 0, effect: 10, description: "Happiness", heromult: 30, heroeffect: 1000000 },
    "Highway to hell": { name: "Highway to hell", expense: 0, effect: 10, description: "Evil Gain", heromult: 30, heroeffect: 1000000 },
    "Tesseract": { name: "Tesseract", expense: 0, effect: 1, description: "Hypercube Gain", heromult: 30, heroeffect: 10 },
    "Desintegration": { name: "Desintegration", expense: 0, effect: 1, description: "Dark Matter Gain", heromult: 30, heroeffect: 100 },
    "Custom Galaxy": { name: "Custom Galaxy", expense: 0, effect: 1, description: "Skill XP", heromult: 30, heroeffect: 1e100 },
    "Hypersphere": { name: "Hypersphere", expense: 0, effect: 1, description: "Hypercube Gain", heromult: 30, heroeffect: 1e50 },
}
